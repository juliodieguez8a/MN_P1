...
#mes de resulado
#suma los 6 meses
m1=y_ajustado[0*parte:1*parte]
m2=y_ajustado[1*parte:2*parte]
m3=y_ajustado[2*parte:3*parte]
m4=y_ajustado[3*parte:4*parte]
m5=y_ajustado[4*parte:5*parte]
m6=y_ajustado[5*parte:6*parte]
